...
This project is an MCP server built on [`@eliware/mcp-server`](https://www.npmjs.com/package/@eliware/mcp-server) [![npm version](https://img.shields.io/npm/v/@eliware/mcp-server.svg)](https://www.npmjs.com/package/@eliware/mcp-server). It exposes a set of tools via the Model Context Protocol, making them accessible to AI agents and automation clients.
...
4. **Call tools via HTTP or MCP client.**  
   See the [@eliware/mcp-server documentation](https://www.npmjs.com/package/@eliware/mcp-server) for protocol/API details.
...
- [@eliware/mcp-server on npm](https://www.npmjs.com/package/@eliware/mcp-server)
